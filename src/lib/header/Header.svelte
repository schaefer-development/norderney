	...
	<div class="absolute z-50 top-0 left-0 right-0 w-full max-w-screen-xl mx-auto ">
		...
		<div class="menu hidden lg:block">
			<div class="flex flex-row justify-center">
				<a href="{base}/" class="relative mx-4">
					<span
						class="relative menupoint uppercase font-bold tracking-widest text-no_brown hover:text-no_brown-lighter"
						>Start</span
					>
				</a>
				<a href="{base}/lage" class="relative mx-4">
					<span
						class="relative menupoint uppercase font-bold tracking-widest text-no_brown  hover:text-no_brown-lighter"
...
>
	<div class="flex flex-col flex-wrap px-6 py-4 mx-auto w-full menu_points">
		<div class="flex justify-end w-full block">
			...
			>
				<span class="text-xl px-2">Schliessen</span>
				<svg
