...
<div class="pt-12 flex justify-center">
	<div>
		<div class="flex flex-row pb-2">
			<div class="py-1 pr-4 flex text-amber-400">
				<svg
			...
			<span class="font-bold"
				>5.0/5 Gesamtwertung auf <a
					href="https://www.traum-ferienwohnungen.de/162863/?tp=1"
					target="_blank">Traumferienwohnung</a
				></span
			>
		</div>

		<div class="flex flex-row">
			<span class="pr-4">5.0 Ausstattung</span><span class="pr-4">5.0 Service</span><span
				class="pr-4">5.0 Preis/Leistung</span
			><span class="pr-4">5.0 Umgebung</span>
		</div>
	</div>
</div>
