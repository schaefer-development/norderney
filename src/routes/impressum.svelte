	...
	<section class="relative first_section bg-white px-6 lg:px-12 py-6 lg:py-12 edge">
		...
		<div class="grid grid-cols-2 gap-x-12">
			<div class="left col-span-2 lg:col-span-1">
				<!-- -->
				<h2 class="pb-6">Pflichtangaben gemäß §5 TMG</h2>
				<h3>Name und Anschrift des Dienstanbieters:</h3>
				<p class="pb-10">
					Dr. Marion Bertgen-Giesen<br />
					Gregor-Mendel-Straße 26<br />
					53115 Bonn<br />
					Steuernummer: 205/5023/0090 <br />
				</p>

				<h3>Angaben zur Kontaktaufnahme mit dem Dienstanbieter:</h3>
				<p class="pb-10">
			...
			<div class="left col-span-2 lg:col-span-1">
				<!-- -->
				<h2 class="pb-6">Haftung, Datenschutz und mehr:</h2>
