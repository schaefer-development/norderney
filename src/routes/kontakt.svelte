...
<svelte:head>
	<title>Kontakt: Am Meer Norderneys</title>
...
<section>
	<h2 class="pb-2">
		...
		und
		<a href="mailto:m.bertgen@t-online.de">schreiben Sie uns!</a> <br />Wir geben gerne Auskunft und
		freuen uns auf Ihren Besuch auf Norderney!
	</h2>

	<h1 class="h1 text-darkblue pt-8 pb-4">Kontakt Vermietung</h1>
